...

{
...

	{
		...
		// Localize our plugin.
//		add_action( 'load_trans', [ $this, 'localization_setup' ] );
...

	{
		...
		$this->form_fields = array(
				...
				'title' => array(
						...
						'default' => __('ZoodPay BNPL', 'zoodpay'),
				...
				'description' => array(
						...
						'default' => __('ZoddPay Description'),
						'desc_tip' => true,
			...
			'services' => array(
				...
				'title' => __('Available Services', 'zoodpay'),

				'type' => 'textarea',
				'custom_attributes' => array('readonly'=>'readonly'),
				'description' => __('This Shows the ZoodPay Services Available ', 'zoodpay'),

				'default' => __('No Service is Available'),
				...
				'environment' => array(
						...
						'title' => __('API MODE', 'zoodpay'),
						'type' => 'select',

						'options' => array(

								'https://sandbox-api.zoodpay.com/v0/' => 	'Sandbox' ,
								'https://api.zoodpay.com/v0/'	 => 'Live',

						) ,

						'default' => 'Live',

						'description' => __('Place Choose the payment gateway API Mode.', 'zoodpay'),
...

	{
		...
		}else if(isset($customer_order->billing_postcode) && $customer_order->billing_postcode != ''){
			$shiping_code = $customer_order->billing_postcode;
		}
		else {
            $shiping_code = $default_postcode[$shiping_count];
        }
		if(isset($customer_order->billing_postcode) && $customer_order->billing_postcode != ''){
			$billing_postcode = $customer_order->billing_postcode;
		}else if(isset($customer_order->shipping_postcode) && $customer_order->shipping_postcode != ''){
			$billing_postcode = $customer_order->billing_postcode;
		}
		else {
			$billing_postcode =$default_postcode[$customer_order->billing_country];
		}
